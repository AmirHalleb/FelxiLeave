...
const LeaveForm = () => {
  ...
  const [justification, setJustification] = useState(''); // Added justification state

  
  const handleDateChange = (type, event, value) => {
      ...
      <View style={styles.formContainer}>
        ...
        <View style={styles.leaveTypeContainer}>
          ...
          >
            ...
            <Text style={{ color: leaveType ? '#000' : '#888', marginLeft: 30 }}>
              {leaveType || 'Select Leave Type'}
            </Text>
          </TouchableOpacity>

          {leaveType && (
            <TouchableOpacity onPress={() => setLeaveType('')} style={styles.removeIcon}>
        ...
        <View style={styles.dateTimeContainer}>
          <View style={styles.datePickerContainer}>
            ...
            <TouchableOpacity onPress={() => setShowPicker((prev) => ({ ...prev, startDate: true }))} style={styles.datePicker}>
          ...
          <View style={styles.timePickerContainer}>
            ...
            <TouchableOpacity onPress={() => setShowPicker((prev) => ({ ...prev, startTime: true }))} style={styles.datePicker}>
              <Icon name="time-outline" size={20} color="#555" style={styles.icon} />
              <Text>{dateRange.startTime.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</Text>
            </TouchableOpacity>
        ...
        <View style={styles.fileUploadContainer}>
          <Text style={styles.fieldLabel}>Upload Attachment (Optional)</Text>
